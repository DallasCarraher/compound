## API Report File for "@cmpd/compound"
...
import { ArrayOfValidator } from '@cmpd/editor';
import { BaseBoxShapeTool } from '@cmpd/editor';
import { BaseBoxShapeUtil } from '@cmpd/editor';
import { Box2d } from '@cmpd/editor';
import { Circle2d } from '@cmpd/editor';
import { CubicSpline2d } from '@cmpd/editor';
import { DictValidator } from '@cmpd/editor';
import { Editor } from '@cmpd/editor';
import { EMBED_DEFINITIONS } from '@cmpd/editor';
import { EmbedDefinition } from '@cmpd/editor';
import { EnumStyleProp } from '@cmpd/editor';
import { Geometry2d } from '@cmpd/editor';
import { Group2d } from '@cmpd/editor';
import { JsonObject } from '@cmpd/editor';
import { LANGUAGES } from '@cmpd/editor';
import { Matrix2d } from '@cmpd/editor';
import { Matrix2dModel } from '@cmpd/editor';
import { MigrationFailureReason } from '@cmpd/editor';
import { Migrations } from '@cmpd/editor';
import { NamedExoticComponent } from 'react';
import { ObjectValidator } from '@cmpd/editor';
import { Polygon2d } from '@cmpd/editor';
import { Polyline2d } from '@cmpd/editor';
import { default as React_2 } from 'react';
import * as React_3 from 'react';
import { ReactNode } from 'react';
import { Rectangle2d } from '@cmpd/editor';
import { RecursivePartial } from '@cmpd/editor';
import { Result } from '@cmpd/editor';
import { SelectionCorner } from '@cmpd/editor';
import { SelectionEdge } from '@cmpd/editor';
import { SelectionHandle } from '@cmpd/editor';
import { SerializedSchema } from '@cmpd/editor';
import { ShapeUtil } from '@cmpd/editor';
import { SnapPoint } from '@cmpd/editor';
import { StateNode } from '@cmpd/editor';
import { StoreSnapshot } from '@cmpd/editor';
import { SvgExportContext } from '@cmpd/editor';
import { TLAnyShapeUtilConstructor } from '@cmpd/editor';
import { TLArrowShape } from '@cmpd/editor';
import { TLAssetId } from '@cmpd/editor';
import { TLBaseEventInfo } from '@cmpd/editor';
import { TLBookmarkShape } from '@cmpd/editor';
import { TLCancelEvent } from '@cmpd/editor';
import { TLClickEvent } from '@cmpd/editor';
import { TLClickEventInfo } from '@cmpd/editor';
import { TLDefaultSizeStyle } from '@cmpd/editor';
import { TldrawEditorBaseProps } from '@cmpd/editor';
import { TLDrawShape } from '@cmpd/editor';
import { TLDrawShapeSegment } from '@cmpd/editor';
import { TLEmbedShape } from '@cmpd/editor';
import { TLEnterEventHandler } from '@cmpd/editor';
import { TLEventHandlers } from '@cmpd/editor';
import { TLExitEventHandler } from '@cmpd/editor';
import { TLFrameShape } from '@cmpd/editor';
import { TLGeoShape } from '@cmpd/editor';
import { TLHandle } from '@cmpd/editor';
import { TLHandlesComponent } from '@cmpd/editor';
import { TLHighlightShape } from '@cmpd/editor';
import { TLHoveredShapeIndicatorComponent } from '@cmpd/editor';
import { TLImageShape } from '@cmpd/editor';
import { TLInterruptEvent } from '@cmpd/editor';
import { TLKeyboardEvent } from '@cmpd/editor';
import { TLKeyboardEventInfo } from '@cmpd/editor';
import { TLLanguage } from '@cmpd/editor';
import { TLLineShape } from '@cmpd/editor';
import { TLNoteShape } from '@cmpd/editor';
import { TLOnBeforeCreateHandler } from '@cmpd/editor';
import { TLOnBeforeUpdateHandler } from '@cmpd/editor';
import { TLOnDoubleClickHandler } from '@cmpd/editor';
import { TLOnEditEndHandler } from '@cmpd/editor';
import { TLOnHandleChangeHandler } from '@cmpd/editor';
import { TLOnResizeEndHandler } from '@cmpd/editor';
import { TLOnResizeHandler } from '@cmpd/editor';
import { TLOnTranslateStartHandler } from '@cmpd/editor';
import { TLParentId } from '@cmpd/editor';
import { TLPointerEvent } from '@cmpd/editor';
import { TLPointerEventInfo } from '@cmpd/editor';
import { TLPointerEventName } from '@cmpd/editor';
import { TLRecord } from '@cmpd/editor';
import { TLRotationSnapshot } from '@cmpd/editor';
import { TLSchema } from '@cmpd/editor';
import { TLScribbleComponent } from '@cmpd/editor';
import { TLSelectionBackgroundComponent } from '@cmpd/editor';
import { TLSelectionForegroundComponent } from '@cmpd/editor';
import { TLSelectionHandle } from '@cmpd/editor';
import { TLShape } from '@cmpd/editor';
import { TLShapeId } from '@cmpd/editor';
import { TLShapePartial } from '@cmpd/editor';
import { TLShapeUtilCanvasSvgDef } from '@cmpd/editor';
import { TLShapeUtilFlag } from '@cmpd/editor';
import { TLStore } from '@cmpd/editor';
import { TLStoreWithStatus } from '@cmpd/editor';
import { TLSvgOptions } from '@cmpd/editor';
import { TLTextShape } from '@cmpd/editor';
import { TLUnknownShape } from '@cmpd/editor';
import { TLVideoShape } from '@cmpd/editor';
import { UnionValidator } from '@cmpd/editor';
import { UnknownRecord } from '@cmpd/editor';
import { Validator } from '@cmpd/editor';
import { Vec2d } from '@cmpd/editor';
import { Vec2dModel } from '@cmpd/editor';
